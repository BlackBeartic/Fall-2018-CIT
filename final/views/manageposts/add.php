...
<div class="container">
  ...
  <div class="row">
      <div class="span8">
        <form id = "addpost" action="<?php echo BASE_URL?>manageposts/<?php echo $task?>" method="post" onsubmit="editor.post() && return validateForm()" required = "title">
          <label>Title</label>
...
function validateForm() {
  ...
  var d = document.forms["addpost"]["title"].value;
  if (d == "") {
    alert("Title must be filled out");
    return false;
  }
	var e = document.forms["addpost"]["date"].value;
	if (e == "") {
